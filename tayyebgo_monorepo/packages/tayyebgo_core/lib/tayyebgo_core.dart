...
export 'presentation/shared_widgets/press_scale.dart' hide PressScale;
...
export 'src/theme/premium_animations.dart' hide ShimmerLoading, SlideDirection, PulseAnimation;
...
export 'src/services/customer_ai_service.dart' hide ChatMessage;
