      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _pickSection(context, 'Best Burgers', Icons.lunch_dining_rounded, AppColors.primary, ['Smash Bros', 'Burger Factory', 'The Patty Club']),
            const SizedBox(height: 20),
            _pickSection(context, 'Best Coffee', Icons.coffee_rounded, AppColors.adminAccent, ['Café Latte', 'Bean House', 'Morning Brew']),
            const SizedBox(height: 20),
            _pickSection(context, 'Local Favorites', Icons.favorite_rounded, AppColors.error, ['Damascus Kitchen', 'Al Sham', 'Home Taste']),
            const SizedBox(height: 20),
