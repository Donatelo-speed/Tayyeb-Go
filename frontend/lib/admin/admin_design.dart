...
class AdminColors {
  ...
  static List<Color> roleColors(String role) {
    switch (role) {
      case 'superAdmin': return [Color(0xFFEF4444), Color(0xFFDC2626)];
      case 'restaurantOwner': return [Color(0xFF3B82F6), Color(0xFF2563EB)];
      case 'cashier': return [Color(0xFF8B5CF6), Color(0xFF7C3AED)];
      case 'driver': return [Color(0xFFF59E0B), Color(0xFFD97706)];
      case 'customer': return [Color(0xFF10B981), Color(0xFF059669)];
      default: return [Color(0xFF6366F1), Color(0xFF4F46E5)];
    }
  }
  ...
  static Color statusColor(String status) {
    switch (status) {
      ...
      case 'ready_for_driver': return Color(0xFF06B6D4);
      case 'picked_up': return Color(0xFFF97316);
      case 'delivered': return success;
      case 'cancelled': return danger;
      case 'open': return info;
      case 'assigned': return secondary;
      case 'in_progress': return Color(0xFF8B5CF6);
      case 'resolved': return success;
      case 'closed': return Color(0xFF94A3B8);
  ...
  static ThemeData dark() {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.dark(
        ...
        surface: AdminColors.bgDarkCard,
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: AdminColors.bgDarkInput,
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(AdminRadius.lg), borderSide: BorderSide.none),
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AdminRadius.lg), borderSide: BorderSide(color: AdminColors.borderDark)),
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AdminRadius.lg), borderSide: const BorderSide(color: AdminColors.primary, width: 2)),
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
        hintStyle: const TextStyle(color: AdminColors.textDarkMuted),
        labelStyle: const TextStyle(color: AdminColors.textDarkSecondary),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: AdminTypography.buttonText,
        ),
      ),
  ...
  static ThemeData light() {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        primary: AdminColors.primary,
        secondary: AdminColors.secondary,
        surface: AdminColors.bgLightCard,
        error: AdminColors.danger,
      ),
      fontFamily: AdminTypography.fontFamily,
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: AdminColors.bgLightInput,
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(AdminRadius.lg), borderSide: BorderSide.none),
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AdminRadius.lg), borderSide: BorderSide(color: AdminColors.borderLight)),
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(AdminRadius.lg), borderSide: const BorderSide(color: AdminColors.primary, width: 2)),
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
        hintStyle: const TextStyle(color: AdminColors.textLightMuted),
